...
export default function MembershipRequired({
      ...
      <Card className="max-w-2xl mx-auto my-8 shadow-lg">
        ...
        <CardContent>
          <p className="text-center mb-4">
            The {featureToNameMap[feature]} requires a{" "}
            {featureToTierMap[feature]} membership or higher. Please sign in to
            access this feature.
          </p>
        </CardContent>
  ...
  return (
    <Card className="max-w-2xl mx-auto my-8 shadow-lg">
      ...
      <CardContent>
        <p className="text-center mb-4">
          The {featureToNameMap[feature]} requires a {featureToTierMap[feature]}{" "}
          membership or higher. Your current tier is:{" "}
