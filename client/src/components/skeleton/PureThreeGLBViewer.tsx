...
export const CAMERA_PRESETS: Record<CameraAngle, CameraAngleConfig> = {
  front: { position: { x: 0, y: 0, z: 2.5 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Front View' },
  back: { position: { x: 0, y: 0, z: -2.5 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Back View' },
  left: { position: { x: -2.5, y: 0, z: 0 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Left Side' },
  right: { position: { x: 2.5, y: 0, z: 0 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Right Side' },
  top: { position: { x: 0, y: 5, z: 0.1 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Top View (Transverse)' },
  perspective: { position: { x: 2, y: 0.5, z: 2 }, lookAt: { x: 0, y: 0, z: 0 }, label: '3/4 View' },
  custom: { position: { x: 0, y: 0, z: 2.5 }, lookAt: { x: 0, y: 0, z: 0 }, label: 'Custom' },
};
