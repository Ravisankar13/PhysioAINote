...
export function SkeletonModel() {
  ...
  return (
    <div className="w-full">
      <div className="mb-6 border rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center p-8">
      ...
      <div className="w-full mb-6 p-4 border rounded-lg bg-white">
