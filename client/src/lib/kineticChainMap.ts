...
const LANDMARK_TO_REGION: Record<string, string> = {
  "c1-c2 (upper cervical)": "Cervical Spine",
  "c3-c4 (mid cervical)": "Cervical Spine",
  "c5-c6 (lower cervical)": "Cervical Spine",
  "c7-t1 (cervicothoracic junction)": "Cervical Spine",
  "c7 spinous process": "Cervical Spine",
  "hyoid bone": "Cervical Spine",
  "tmj (left temporomandibular joint)": "Cervical Spine",
  "tmj (right temporomandibular joint)": "Cervical Spine",
  "occiput (base of skull)": "Cervical Spine",
  "mastoid process (left)": "Cervical Spine",
  "mastoid process (right)": "Cervical Spine",
  ...
  "t1-t4 (upper thoracic)": "Thoracic Spine",
  "t5-t8 (mid thoracic)": "Thoracic Spine",
  "t9-t10 (lower thoracic)": "Thoracic Spine",
  "t11-t12 (thoracolumbar junction)": "Thoracic Spine",
  "left upper ribs (1-4)": "Thoracic Spine",
  "right upper ribs (1-4)": "Thoracic Spine",
  "left mid ribs (5-8)": "Thoracic Spine",
  "right mid ribs (5-8)": "Thoracic Spine",
  "left lower ribs (9-12)": "Thoracic Spine",
  "right lower ribs (9-12)": "Thoracic Spine",
  "sternum": "Thoracic Spine",
  "left costochondral junction (ribs 1-3)": "Thoracic Spine",
  "right costochondral junction (ribs 1-3)": "Thoracic Spine",
  "left costovertebral joint (t1-t6)": "Thoracic Spine",
  "right costovertebral joint (t1-t6)": "Thoracic Spine",
  "left costovertebral joint (t7-t12)": "Thoracic Spine",
  "right costovertebral joint (t7-t12)": "Thoracic Spine",
  ...
  "l1-l2 (upper lumbar)": "Lumbar Spine",
  "l3 (mid lumbar)": "Lumbar Spine",
  "l4-l5 (lower lumbar)": "Lumbar Spine",
  "l5-s1 (lumbosacral junction)": "Lumbar Spine",
  "sacrum": "Lumbar Spine",
  "coccyx": "Lumbar Spine",
  ...
  "l1-l2 facet joint (left)": "Lumbar Spine",
  "l1-l2 facet joint (right)": "Lumbar Spine",
  "l2-l3 facet joint (left)": "Lumbar Spine",
  "l2-l3 facet joint (right)": "Lumbar Spine",
  "l3-l4 facet joint (left)": "Lumbar Spine",
  "l3-l4 facet joint (right)": "Lumbar Spine",
  "l4-l5 facet joint (left)": "Lumbar Spine",
  "l4-l5 facet joint (right)": "Lumbar Spine",
  "l5-s1 facet joint (left)": "Lumbar Spine",
  "l5-s1 facet joint (right)": "Lumbar Spine",
  ...
  "left si joint": "Pelvis",
  "right si joint": "Pelvis",
  "left asis (anterior superior iliac spine)": "Pelvis",
  "right asis (anterior superior iliac spine)": "Pelvis",
  "left psis (posterior superior iliac spine)": "Pelvis",
  "right psis (posterior superior iliac spine)": "Pelvis",
  ...
  "left acetabulum (hip socket)": "Left Hip",
  "right acetabulum (hip socket)": "Right Hip",
  "left hamstring origin": "Left Hip",
  "right hamstring origin": "Right Hip",
  "left adductor origin": "Left Hip",
  "right adductor origin": "Right Hip",
  "left asis": "Pelvis",
  "right asis": "Pelvis",
  "left psis": "Pelvis",
  "right psis": "Pelvis",
  "left acetabulum": "Pelvis",
  "right acetabulum": "Pelvis",

  "left acromioclavicular joint": "Left Shoulder",
  "right acromioclavicular joint": "Right Shoulder",
  ...
  "left deltoid tuberosity": "Left Shoulder",
  "right deltoid tuberosity": "Right Shoulder",
  "left sternoclavicular joint": "Left Shoulder",
  "right sternoclavicular joint": "Right Shoulder",
  "left infrascapular region": "Left Shoulder",
  "right infrascapular region": "Right Shoulder",
  ...
  "left it band": "Left Hip",
  "right it band": "Right Hip",
  "left biceps": "Left Shoulder",
  "right biceps": "Right Shoulder",
  "left mid-thigh (quadriceps)": "Left Hip",
  "right mid-thigh (quadriceps)": "Right Hip",
  ...
  "left medial knee joint line": "Left Knee",
  "right medial knee joint line": "Right Knee",
  "left lateral knee joint line": "Left Knee",
  "right lateral knee joint line": "Right Knee",
  ...
  "left calcaneus (heel)": "Left Ankle",
  "right calcaneus (heel)": "Right Ankle",
  ...
  "left 5th metatarsal base": "Left Ankle",
  "right 5th metatarsal base": "Right Ankle",
  "left 5th metatarsal head": "Left Ankle",
  "right 5th metatarsal head": "Right Ankle",
  "left plantar fascia": "Left Ankle",
  "right plantar fascia": "Right Ankle",
  "left plantar fascia origin": "Left Ankle",
  "right plantar fascia origin": "Right Ankle",
  "left achilles tendon": "Left Ankle",
  "right achilles tendon": "Right Ankle",
  "left achilles insertion": "Left Ankle",
  "right achilles insertion": "Right Ankle",
  "left calf / gastrocnemius": "Left Ankle",
  "right calf / gastrocnemius": "Right Ankle",
  "left tibial shaft (mid)": "Left Ankle",
  "right tibial shaft (mid)": "Right Ankle",
  "left anterior tibialis": "Left Ankle",
  "right anterior tibialis": "Right Ankle",
  "left peroneal region": "Left Ankle",
  "right peroneal region": "Right Ankle",
};
