...
export const NERVE_ROOT_PROFILES: NerveRootProfile[] = [
  ...
  },
  {
    ...
    dermatome: {
      nerveRoot: 'T2',
      level: 'T2',
      sensoryTerritory: 'Medial arm, axilla',
      skeletonBones: ['mixamorig:LeftArm', 'mixamorig:RightArm', 'mixamorig:Spine2'],
    },
    myotome: {
      nerveRoot: 'T2',
      muscles: ['Intercostals (upper)'],
      action: 'Rib elevation during inspiration',
      mrcTestInstruction: 'Observe inspiratory rib expansion',
    },
  },
  {
    root: 'T3',
    ...
    dermatome: {
      nerveRoot: 'T3',
      level: 'T3',
      sensoryTerritory: 'Upper thorax, intercostal region',
      skeletonBones: ['mixamorig:Spine2'],
    },
    myotome: {
      nerveRoot: 'T3',
      muscles: ['Intercostals'],
      action: 'Intercostal expansion',
      mrcTestInstruction: 'Observe chest expansion symmetry',
    },
  },
  {
    root: 'T4',
    ...
    dermatome: {
      nerveRoot: 'T4',
      level: 'T4',
      sensoryTerritory: 'Nipple line',
      skeletonBones: ['mixamorig:Spine2'],
    },
    myotome: {
      nerveRoot: 'T4',
      muscles: ['Intercostals'],
      action: 'Intercostal muscle function',
      mrcTestInstruction: 'Observe chest expansion at nipple level',
    },
  },
  {
    root: 'T5',
    ...
    dermatome: {
      nerveRoot: 'T5',
      level: 'T5',
      sensoryTerritory: 'Mid-thorax between nipple and xiphoid',
      skeletonBones: ['mixamorig:Spine2'],
    },
    myotome: {
      nerveRoot: 'T5',
      muscles: ['Intercostals'],
      action: 'Intercostal muscle function',
      mrcTestInstruction: 'Observe chest wall symmetry',
    },
  },
  {
    root: 'T6',
    ...
    dermatome: {
      nerveRoot: 'T6',
      level: 'T6',
      sensoryTerritory: 'Xiphoid process level',
      skeletonBones: ['mixamorig:Spine2', 'mixamorig:Spine1'],
    },
    myotome: {
      nerveRoot: 'T6',
      muscles: ['Intercostals', 'Upper abdominals'],
      action: 'Upper abdominal contraction',
      mrcTestInstruction: 'Beevor sign — observe umbilicus migration during sit-up',
    },
  },
  {
    root: 'T7',
    ...
    dermatome: {
      nerveRoot: 'T7',
      level: 'T7',
      sensoryTerritory: 'Lower thorax above umbilicus',
      skeletonBones: ['mixamorig:Spine1'],
    },
    myotome: {
      nerveRoot: 'T7',
      muscles: ['Intercostals', 'Abdominals'],
      action: 'Trunk flexion assistance',
      mrcTestInstruction: 'Assess trunk flexion strength',
    },
  },
  {
    root: 'T8',
    ...
    dermatome: {
      nerveRoot: 'T8',
      level: 'T8',
      sensoryTerritory: 'Mid-abdomen above umbilicus',
      skeletonBones: ['mixamorig:Spine1'],
    },
    myotome: {
      nerveRoot: 'T8',
      muscles: ['Abdominals (upper)'],
  ...
  },
  {
    ...
    dermatome: {
      nerveRoot: 'T9',
      level: 'T9',
      sensoryTerritory: 'Just above umbilicus',
      skeletonBones: ['mixamorig:Spine1'],
    },
    myotome: {
      nerveRoot: 'T9',
      muscles: ['Abdominals'],
      action: 'Abdominal contraction',
      mrcTestInstruction: 'Assess abdominal reflex above umbilicus',
    },
  },
  {
    root: 'T10',
    ...
    dermatome: {
      nerveRoot: 'T10',
      level: 'T10',
      sensoryTerritory: 'Umbilicus',
      skeletonBones: ['mixamorig:Spine1', 'mixamorig:Spine'],
    },
    myotome: {
      nerveRoot: 'T10',
      muscles: ['Rectus abdominis', 'External oblique'],
      action: 'Abdominal contraction at umbilical level',
      mrcTestInstruction: 'Beevor sign — observe for umbilical migration',
    },
  },
  {
    root: 'T11',
    ...
    dermatome: {
      nerveRoot: 'T11',
      level: 'T11',
      sensoryTerritory: 'Below umbilicus',
      skeletonBones: ['mixamorig:Spine'],
    },
    myotome: {
      nerveRoot: 'T11',
      muscles: ['Lower abdominals', 'Internal oblique'],
      action: 'Lower abdominal contraction',
      mrcTestInstruction: 'Assess lower abdominal reflex',
    },
  },
  {
    root: 'T12',
    ...
    dermatome: {
      nerveRoot: 'T12',
      level: 'T12',
      sensoryTerritory: 'Inguinal ligament, suprapubic region',
      skeletonBones: ['mixamorig:Spine', 'mixamorig:Hips'],
    },
    myotome: {
      nerveRoot: 'T12',
      muscles: ['Lower abdominals', 'Quadratus lumborum'],
      action: 'Trunk lateral flexion, lower abdominal wall',
      mrcTestInstruction: 'Resist trunk lateral flexion',
    },
  },
  {
    root: 'L1',
  ...
  },
  {
    ...
    dermatome: {
      nerveRoot: 'S3',
      level: 'S3',
      sensoryTerritory: 'Medial buttock, perianal region',
      skeletonBones: ['mixamorig:Hips'],
    },
    myotome: {
      nerveRoot: 'S3',
      muscles: ['Pelvic floor muscles', 'Bladder detrusor'],
      action: 'Pelvic floor contraction',
      mrcTestInstruction: 'Assess pelvic floor contraction / anal wink reflex',
    },
  },
  {
    root: 'S4',
    ...
    dermatome: {
      nerveRoot: 'S4',
      level: 'S4',
      sensoryTerritory: 'Perineum, genitalia',
      skeletonBones: ['mixamorig:Hips'],
    },
    myotome: {
      nerveRoot: 'S4',
      muscles: ['Pelvic floor muscles', 'External anal sphincter'],
      action: 'Pelvic floor contraction, bladder/bowel control',
      mrcTestInstruction: 'Assess anal tone and voluntary contraction',
    },
  },
  {
    root: 'S5',
    ...
    dermatome: {
      nerveRoot: 'S5',
      level: 'S5',
      sensoryTerritory: 'Perianal skin, coccygeal region',
      skeletonBones: ['mixamorig:Hips'],
    },
    myotome: {
      nerveRoot: 'S5',
      muscles: ['Coccygeus', 'External anal sphincter'],
      action: 'Coccygeal support',
      mrcTestInstruction: 'Assess anocutaneous reflex (S4-S5)',
    },
  },
];
...
export function getNerveRootForRegion(region: string): NerveRootProfile[] {
  ...
  const regionToRoots: Record<string, string[]> = {
    ...
    'chest': ['T2', 'T3', 'T4', 'T5', 'T6'],
    'abdomen': ['T7', 'T8', 'T9', 'T10', 'T11', 'T12'],
    'rib': ['T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8', 'T9', 'T10', 'T11', 'T12'],
    'groin': ['L1', 'L2'],
    'perineum': ['S3', 'S4', 'S5'],
