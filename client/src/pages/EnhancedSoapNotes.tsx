...
Generated by PhysioGPT Enhanced SOAP Notes
  ...
  // Process browser-generated transcript (from Web Speech API) to generate SOAP notes
  const processWithBrowserTranscript = async (transcript: string) => {
    try {
      setIsGeneratingSoap(true);
      console.log('[WebSpeech] Processing browser transcript:', transcript.length, 'characters');
      setRealTimeTranscript(transcript);
      
      // Send transcript directly to backend to generate SOAP sections
      const response = await fetch('/api/generate-soap-from-transcript', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (data.soapNote) {
        console.log('[WebSpeech] SOAP sections generated:', data.soapNote);
        ...
        toast({
          ...
          description: `Successfully processed ${transcript.length} characters using real-time transcription.`,
        });
      } else {
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Admin Tasks - Moved to second position */}
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
