        ...
        try {
          ...
          ws.onclose = (event) => {
            ...
            if (reconnectAttempts < maxReconnectAttempts) {
              reconnectAttempts++;
              console.log(`[WebSocket] Will attempt reconnection ${reconnectAttempts}/${maxReconnectAttempts} in 2 seconds...`);
              ...
              setTimeout(() => {
                ...
                if (!isRecordingRef.current) {
                  console.log('[WebSocket] Recording stopped, canceling reconnection');
                  return;
                }
