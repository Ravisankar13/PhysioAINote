...
Generated by PhysioGPT Enhanced SOAP Notes
    ...
    try {
      ...
      if (fileSizeMB > MAX_CHUNK_SIZE_MB) {
        ...
        if (data.soapNote) {
          ...
          if (temporaryNoteId && !isContinuousMode) {
            console.log('Updating temporary note ID:', temporaryNoteId, 'with SOAP content');
            const updateData = {
          ...
          if (temporaryNoteId && !isContinuousMode) {
            console.log('Updating temporary note ID:', temporaryNoteId, 'with fallback SOAP content');
            const updateData = {
  ...
  const generateSoapSections = async (transcript: string) => {
    try {
      ...
      if (temporaryNoteId && !isContinuousMode) {
        console.log('Updating temporary note ID:', temporaryNoteId, 'with generated SOAP sections');
        const updateData = {
