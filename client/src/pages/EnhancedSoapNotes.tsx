...
export default function EnhancedSoapNotesPage() {
  ...
  const generateAHTR = async () => {
    try {
      ...
      toast({
        title: "AHTR Generated",
        description: "AHTR submission has been generated and copied to clipboard",
      });
    } catch (error) {
      toast({
        title: "Generation Failed",
        description: "Failed to generate AHTR. Please try again.",
        variant: "destructive",
      });
    }
  };
                ...
                <div className="text-center py-8">
                  ...
                  {realTimeTranscript && (
                    <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="max-h-20 overflow-y-auto text-sm text-gray-700 leading-relaxed">
                        {realTimeTranscript}
                      </div>
                    </div>
                  )}
