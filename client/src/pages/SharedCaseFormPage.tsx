...
const caseSchema = z.object({
  ...
  presentingComplaints: z.string().min(20, 'Please describe the presenting complaints'),
...
export default function SharedCaseFormPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CaseFormValues) => {
      ...
      const res = await apiRequest('PUT', `/api/shared-cases/${caseId}`, processedData);
      return res.json();
    },
    onSuccess: (data) => {
      toast({
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="E.g., Rotator Cuff Tear in a 45-year-old Tennis Player" {...field} />
                        </FormControl>
                        <FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="E.g., Supraspinatus Tear, Low Back Pain" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          A short summary of the case (approximately 2-3 sentences)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="E.g., sports injury, rehabilitation, tendinopathy (comma-separated)" {...field} />
                        </FormControl>
                        <FormDescription>
                          Add keywords to help others find your case (comma-separated)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            This case contains no patient-identifying information
                          </FormLabel>
                          <FormDescription>
                            By checking this box, you confirm that you have removed all patient-identifying information and have anonymized the case sufficiently
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
