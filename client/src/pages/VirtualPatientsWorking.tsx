      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 mb-1">
                            Internal &lt;0° | Normal: 10-20° | External &gt;30°
                          </div>
                          <input
                            type="range"
                            min="-20"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => setKneePathology({ varusValgus: 3, patellaHeight: 1.0, tibialTorsion: 15 })}
                          >
                            Normal Knee
                          </Button>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => setKneePathology({ varusValgus: -10, patellaHeight: 1.0, tibialTorsion: 15 })}
                          >
                            Genu Varum
                          </Button>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => setKneePathology({ varusValgus: 15, patellaHeight: 1.0, tibialTorsion: 15 })}
                          >
                            Genu Valgum
                          </Button>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => setKneePathology({ varusValgus: 3, patellaHeight: 1.3, tibialTorsion: 15 })}
                          >
                            Patella Alta
                          </Button>
                        </div>
                  ...
                  {activeTab === 'shoulder-pathology' && (
                    <div className="space-y-4">
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="text-sm font-medium text-gray-700 flex justify-between">
                            <span>Scapular Protraction</span>
                            <span>{shoulderPathology.scapularProtraction}°</span>
                          </label>
                          <div className="text-xs text-gray-500 mb-1">
                          ...
                          <input
                            ...
                            min="0"
                            max="20"
                            value={shoulderPathology.scapularProtraction}
                            onChange={(e) => setShoulderPathology(prev => ({ ...prev, scapularProtraction: Number(e.target.value) }))}
                            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                          />
                        </div>
                        ...
                        <div>
                          <label className="text-sm font-medium text-gray-700 flex justify-between">
                            ...
                            <span>{shoulderPathology.scapularWinging}mm</span>
                          </label>
                          <div className="text-xs text-gray-500 mb-1">
                            Normal: 0-5mm | Mild: 5-15mm | Severe: &gt;15mm
                          </div>
                          <input
                            type="range"
                            min="0"
                        ...
                        <div>
                          <label className="text-sm font-medium text-gray-700 flex justify-between">
                            <span>GH Internal Rotation</span>
                            <span>{shoulderPathology.ghInternalRotation}°</span>
                          </label>
                          <div className="text-xs text-gray-500 mb-1">
                            Limited &lt;30° | Normal: 30-60° | Hypermobile &gt;80°
                          </div>
                          <input
                            type="range"
                            min="0"
                            max="90"
                            value={shoulderPathology.ghInternalRotation}
                            onChange={(e) => setShoulderPathology(prev => ({ ...prev, ghInternalRotation: Number(e.target.value) }))}
                            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                          />
                        </div>
                      </div>
          ...
          <div className="lg:col-span-4">
            ...
            {/* Patient Selection - Moved underneath Movement Visualization */}
            <Card className="mt-4">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-semibold flex items-center gap-2">
                  ...
                  <CollapsibleContent>
                    <CardContent className="space-y-4">
                      ...
                      <div className="bg-blue-50 p-3 rounded-lg mb-3">
                        <p className="text-sm font-semibold text-blue-800 mb-2">Quick Test Animations:</p>
