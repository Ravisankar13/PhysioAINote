...
- **Focused Clinical Camera System**: Region-specific camera mode with GPT-4o Vision AI analysis for detecting clinical signs, real-time joint angle computation, and automatic mapping to 3D skeleton markers.
