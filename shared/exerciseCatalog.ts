...
export const INTERVENTION_EXERCISE_MAP: Record<string, string[]> = {
  ...
  joint_mob_grade_1_2: ['mt_pa_cervical', 'mt_pa_thoracic', 'mt_pa_lumbar', 'mt_upa_cervical', 'mt_upa_lumbar', 'mt_lat_glide_cervical', 'mt_lat_glide_lumbar', 'mt_snags_cervical', 'mt_snags_lumbar', 'mt_nags_cervical', 'mt_ap_glide_shoulder', 'mt_inf_glide_shoulder', 'mt_post_glide_shoulder', 'mt_mwm_shoulder', 'mt_ap_glide_hip', 'mt_lat_glide_hip', 'mt_pa_glide_knee', 'mt_patella_mob', 'mt_ap_glide_ankle', 'mt_mwm_ankle', 'mt_subtalar_mob', 'mt_mwm_elbow'],
  joint_mob_grade_3_4: ['mt_pa_cervical', 'mt_pa_thoracic', 'mt_pa_lumbar', 'mt_upa_cervical', 'mt_upa_lumbar', 'mt_lat_glide_cervical', 'mt_lat_glide_lumbar', 'mt_rotation_mob_thoracic', 'mt_ap_glide_shoulder', 'mt_inf_glide_shoulder', 'mt_post_glide_shoulder', 'mt_ap_glide_hip', 'mt_lat_glide_hip', 'mt_pa_glide_knee', 'mt_patella_mob', 'mt_ap_glide_ankle', 'mt_subtalar_mob'],
  soft_tissue_release: ['mt_str_upper_trap', 'mt_str_suboccipital', 'mt_str_piriformis', 'mt_str_psoas', 'mt_str_tfl_itb', 'mt_str_gastroc', 'mt_str_pec_minor', 'mt_str_scm', 'mt_str_thoracolumbar', 'mt_str_quadratus'],
  trigger_point_therapy: ['mt_trigger_point', 'mt_dry_needling'],
